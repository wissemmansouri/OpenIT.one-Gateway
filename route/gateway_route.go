...
import (
	...
	"github.com/wissemmansouri/OpenIT.one-Gateway/service"
	"go.uber.org/zap"
)
...
func rewriteRequestSourceIP(r *http.Request) {
	...
	// fix https://github.com/wissemmansouri/OpenIT.one/issues/1247
...
func (g *GatewayRoute) GetRoute() *http.ServeMux {
	...
	gatewayMux.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		// to fix https://github.com/wissemmansouri/OpenIT/security/advisories/GHSA-32h8-rgcj-2g3c#event-102885
