...
import (
	...
	"github.com/wissemmansouri/OpenIT.one-Gateway/common"
	"github.com/wissemmansouri/OpenIT.one-Gateway/route"
...
var (
	...
	//go:embed build/sysroot/etc/openit/gateway.ini.sample
	_confSample string
)
